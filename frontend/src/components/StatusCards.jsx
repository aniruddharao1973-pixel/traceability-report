...
export function StatusCards({ orders = [], statusSummary = null }) {
  ...
  if (!hasSummary && Array.isArray(orders)) {
    ...
    if (orders.length > 0) {
      const normalizeStatus = (order) => {
        ...
        const s = raw.toString().trim().toLowerCase();
        if (!s) return "";
        if (s.includes("pass") || s.includes("completed") || s === "complete")
          return "Completed";
        if (s.includes("scrap") || s.includes("scrapped")) return "Scrap";
        if (
      ...
      for (const o of orders) {
        ...
        if (
          ...
          String(nextEnd) > String(currEnd) ||
          (String(nextEnd) === String(currEnd) &&
            String(nextStart) > String(currStart))
        ) {
          byUid.set(uid, o);
        }
      }
  ...
  return (
    <div
      ...
      p-3 md:p-4 lg:p-5
      border border-sky-200/50 dark:border-purple-500/30 
      overflow-hidden w-full
    "
    >
      {/* HEADER */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 md:gap-4 mb-4 md:mb-6">
        <div className="flex items-center gap-2 md:gap-3">
          <div className="p-1.5 md:p-2 lg:p-2.5 bg-gradient-to-br from-sky-400 to-purple-600 rounded-lg md:rounded-xl shadow-lg">
            <svg
          ...
          <h2 className="text-base md:text-lg font-bold bg-gradient-to-r from-sky-600 to-purple-600 bg-clip-text text-transparent">
            Production Status
          </h2>
        </div>
      ...
      >
        ...
        "
        >
          <div className="absolute top-0 right-0 w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-purple-400/20 to-transparent rounded-tr-xl md:rounded-tr-2xl rounded-bl-full"></div>

          <div className="relative">
            <div className="flex items-center justify-between mb-2 md:mb-3">
              <div className="flex items-center gap-2">
                <div className="p-1.5 md:p-2 bg-gradient-to-br from-sky-400 to-blue-600 rounded-lg">
                  <svg
              ...
              <div className="flex items-center gap-2">
                <span className="text-base md:text-lg font-black bg-gradient-to-r from-sky-600 to-purple-600 bg-clip-text text-transparent">
                  {total}
                </span>
              </div>
            </div>
            ...
            <div className="relative">
              <div
                className="w-full bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 
                              dark:from-gray-700 dark:to-gray-600 rounded-full h-2.5 md:h-3 shadow-inner overflow-hidden"
              >
                <div
                  className="relative h-2.5 md:h-3 rounded-full 
                                bg-gradient-to-r from-sky-500 via-blue-500 to-purple-600 
                                shadow-lg transition-all duration-500"
                  style={{ width: "100%" }}
                >
          ...
          <div className="pt-3 md:pt-4">
            <div className="flex flex-col gap-1 mb-2">
              ...
              <div className="flex items-baseline gap-1 md:gap-2">
                <span className="text-xl md:text-2xl font-black bg-gradient-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent">
                  {showCompleted}
                </span>
                <span className="text-sm md:text-lg font-bold text-emerald-500 dark:text-emerald-400">
                  /{total}
                </span>
              </div>
            </div>
            ...
            <div className="relative">
              <div
                className="w-full bg-gradient-to-r from-emerald-100 to-green-100 dark:from-gray-700 dark:to-gray-600 
                              rounded-full h-3 md:h-4 shadow-inner overflow-hidden"
              >
                <div
                  className="relative h-3 md:h-4 rounded-full bg-gradient-to-r from-emerald-500 via-green-500 to-emerald-600 
                                shadow-lg transition-all duration-700 ease-out group-hover:shadow-emerald-500/50"
                  style={{ width: `${Math.min(completedPercentage, 100)}%` }}
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/40 to-transparent animate-shimmer"></div>
        ...
        >
          ...
          >
            <svg
              className="w-2.5 h-2.5 md:w-3 md:h-3 text-white animate-spin-slow"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <div className="pt-3 md:pt-4">
            <div className="flex flex-col gap-1 mb-2">
              <div className="flex items-center justify-between">
                <p className="text-[10px] md:text-xs font-semibold text-amber-600 dark:text-amber-400 uppercase tracking-wider">
                  In Progress
                </p>
                <div
                  className="px-1.5 md:px-2 py-0.5 md:py-1 
              ...
              <div className="flex items-baseline gap-1 md:gap-2">
                <span className="text-xl md:text-2xl font-black bg-gradient-to-r from-amber-600 to-orange-600 bg-clip-text text-transparent">
                  {showInProgress}
                </span>
                <span className="text-sm md:text-lg font-bold text-amber-500 dark:text-amber-400">
                  /{total}
                </span>
              </div>
            </div>
            ...
            <div className="relative">
              <div
                className="w-full bg-gradient-to-r from-amber-100 to-orange-100 dark:from-gray-700 dark:to-gray-600 
                              rounded-full h-3 md:h-4 shadow-inner overflow-hidden"
              >
                <div
                  className="relative h-3 md:h-4 rounded-full bg-gradient-to-r from-amber-500 via-yellow-500 to-orange-600 
                                shadow-lg transition-all duration-700 ease-out group-hover:shadow-amber-500/50"
                  style={{
                    width: `${Math.max(Math.min(inProgressPercentage, 100), showInProgress > 0 ? 1 : 0)}%`,
                  }}
        ...
        >
          ...
          <div className="pt-3 md:pt-4">
            <div className="flex flex-col gap-1 mb-2">
              <div className="flex items-center justify-between">
                <p className="text-[10px] md:text-xs font-semibold text-red-600 dark:text-red-400 uppercase tracking-wider">
                  Scrap
                </p>
                <div
                  className="px-1.5 md:px-2 py-0.5 md:py-1 
              ...
              <div className="flex items-baseline gap-1 md:gap-2">
                <span className="text-xl md:text-2xl font-black bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">
                  {showScrap}
                </span>
                <span className="text-sm md:text-lg font-bold text-red-500 dark:text-red-400">
                  /{total}
                </span>
              </div>
            </div>
            ...
            <div className="relative">
              <div
                className="w-full bg-gradient-to-r from-red-100 to-rose-100 dark:from-gray-700 dark:to-gray-600 
                              rounded-full h-3 md:h-4 shadow-inner overflow-hidden"
              >
                <div
                  className="relative h-3 md:h-4 rounded-full bg-gradient-to-r from-red-500 via-rose-500 to-red-600 
                                shadow-lg transition-all duration-700 ease-out group-hover:shadow-red-500/50"
                  style={{
                    width: `${Math.max(Math.min(scrapPercentage, 100), showScrap > 0 ? 1 : 0)}%`,
                  }}
