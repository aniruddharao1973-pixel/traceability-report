...
const EmptyState = () => {
  return (
    <div className="p-12 text-center">
      ...
      <p className="text-xs text-gray-400">Try selecting a different report type</p>
    </div>
  );
};
          ...
          <div className="mb-6">
            ...
            <div className="rounded-xl overflow-hidden border-2 border-gray-200 bg-gray-50 transition-all duration-300">
              <div className="max-h-72 overflow-auto custom-scrollbar">
                ...
                {/* Empty State */}
                {!loading && Array.isArray(rows) && rows.length === 0 && <EmptyState />}
                  ...
                  rows.map((r, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {selectedUid === uid && (
                          <ChevronRight size={18} className="text-purple-500 animate-pulse" />
                        )}
                      </div>
                    );
                  })}
