...
//       <h2 className="text-lg font-bold bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400 bg-clip-text text-transparent whitespace-nowrap">
//         Production Records
//       </h2>

//       {/* Vertical Divider */}
//       <div className="w-px h-6 bg-gradient-to-b from-indigo-300 to-purple-300 dark:from-gray-600 dark:to-gray-700"></div>
...
//       <span className="ml-1 text-[10px] opacity-80">({customFrom} to {customTo})</span>
//     )}
//   </button>
...
//       <div className="absolute top-full left-0 mt-2 p-5 bg-gradient-to-br from-white to-indigo-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl border-2 border-indigo-200 dark:border-indigo-700 shadow-2xl z-50 min-w-[420px] backdrop-blur-sm">
//         {/* Header */}
...
//               className="w-full px-4 py-2.5 text-sm border-2 border-indigo-200 dark:border-indigo-700 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white transition-all shadow-sm hover:shadow-md"
//             />
//           </div>
...
//               className="flex-1 px-4 py-2.5 bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-sm font-bold rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 transition-all duration-200 flex items-center justify-center gap-2"
//             >
...
//                 setShowCustomPicker(false);
//               }}
//               className="flex-1 px-4 py-2.5 bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-600 text-gray-700 dark:text-gray-300 text-sm font-bold rounded-xl shadow-md hover:shadow-lg hover:scale-[1.02] transition-all duration-200 flex items-center justify-center gap-2"
//             >
//               <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
//                 <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd"/>
//               </svg>
